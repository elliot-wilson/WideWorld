    ...
    return (
        <section className="about">
            ...
            <section>
                ...
                <img width="800px" src="https://wide-world-seeds.s3.us-east-1.amazonaws.com/readme_photos/normalizedState.png"/>
                <br/>
                <br/>
            </section>
            ...
            <section>
                <img className="prof-pic" src="https://wide-world-seeds.s3.us-east-1.amazonaws.com/readme_photos/profpic.jpeg"/>
                ...
                <p>I'd love to chat! Check out my <a href="https://www.elliotwilson.me" target="_blank" rel="noopener noreferrer">portfolio</a> and reach out to me on <a href="https://www.linkedin.com/in/elliot-wilson-4897a81b9/" target="_blank" rel="noopener noreferrer">LinkedIn</a> or via <a href="mailto:elliot.andrew.wilson@gmail.com" target="_blank" rel="noopener noreferrer">email</a>.</p>
            </section>
        </section>
    )
}
